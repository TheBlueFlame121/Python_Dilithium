"""
This contains an implementation of the DRBG used in Dilithium. In the reference implementation they have coded it up from scratch which is beyond the scope of this implementation and frankly overkill. Additionally there are also talks about changing the symmetric primitives in the final version of Dilithium so there is a chance this could be replaced anyway.

This implementation of AES256_CTR_DRBG is taken directly from https://github.com/jack4818/dilithium-py/blob/main/aes256_ctr_drbg.py#L64 and all credit goes to Giacomo Pope.
"""
import os
